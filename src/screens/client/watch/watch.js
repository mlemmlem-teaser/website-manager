...
function buildBannerSection(movie) {
  ...
  div.innerHTML = `
            ...
            <p class="banner__info">Trending in movies | Released - ${new Date(
              movie.release_date
            ...
            <div class="action-buttons-cont">
                <button class="action-button" style="margin-right: 10px;color: black" onclick="document.querySelector('.content').style.display = 'none'; document.querySelector('.watch').style.display = 'block'">▶ Play</button>
