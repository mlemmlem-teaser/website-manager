  ...
  getAllUsers()
    .then((allUsers) => {
      ...
      allUsers.forEach((user) => {
        ...
        ID.classList.add("textcenter");
        const Email = document.createElement("td");
        Email.innerText = user.email;
        Email.classList.add("padding");
        const Name = document.createElement("td");
        Name.innerText = user.name != null ? user.name : user.username;
        Name.classList.add("padding");
        const Birth = document.createElement("td");
        Birth.innerText = user.date;
        Birth.classList.add("textcenter");
        const Gender = document.createElement("td");
        Gender.innerText = user.gender;
        Gender.classList.add("textcenter");
        const Created = document.createElement("td");
        Created.innerText = user.accountCreated;
        Created.classList.add("textcenter");
        const Setting = document.createElement("td");
        Setting.classList.add("textcenter");
        ...
        const authSetting = document.createElement("i");
        authSetting.classList.add("fa-solid", "fa-pen", "authSetting");
        const authDelete = document.createElement("i");
        authDelete.classList.add("fa-solid", "fa-toggle-on", "authDelete");
